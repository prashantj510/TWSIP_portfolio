  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Portfolio webpage made by Prashant Kuamr Jha"
        />
      </Head>
      <TransitionEffect/>
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full md:h-full md:self-center">
              <Image
                src={profilePic}
                alt="Code"
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href="/Prashant's Resume22-08-23.pdf"
                  target={"_blank"}
        ...
        <div className=" absolute right-8 bottom-8 inline-block w-24 ">
          <Image priority src={lightBulb} alt=" Portfolio" className="w-full h-auto md:hidden" />
        </div>
      </main>
    </>
  );
