...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      className=" flex items-center justify-center rounded-full font-semibold bg-dark text-light  shadow-dark absolute dark:bg-light dark:text-dark cursor-pointer py-3 px-6 lg:py-2 lg:px-4 md:text-sm md:py-1 md:px-3 xs:bg-transparent xs:dark:bg-transparent xs:text-dark xs:dark:text-light xs:font-bold "
